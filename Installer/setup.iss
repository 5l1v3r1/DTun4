...
Name: runonstartup; Description: Start DTun4 when Windows starts; Flags: checkedonce
...
Source: tap-win32\InstallDTun4Adapter.exe; DestDir: {app}\tap-install; Flags: ignoreversion
Source: tap-win32\OemWin2k.inf; DestDir: {app}\tap-install; Flags: ignoreversion
Source: tap-win32\tap4955.sys; DestDir: {app}\tap-install; Flags: ignoreversion
Source: tap-win32\tapinstall.exe; DestDir: {app}\tap-install; Flags: ignoreversion
Source: tap-win32\license.txt; DestDir: {app}\tap-install; Flags: ignoreversion
...
[UninstallDelete]
Name: {app}\log.txt; Type: files; Tasks: ; Languages: 
[Registry]
